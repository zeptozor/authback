    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, auth_1.default.getUser(email)];
            case 1:
                user = _a.sent();
                if (!(typeof user == 'string')) return [3 /*break*/, 3];
                return [4 /*yield*/, auth_1.default.createUser(email)];
            case 2:
                user = _a.sent();
                _a.label = 3;
            case 3: return [4 /*yield*/, auth_1.default.createToken(user.uid)];
            case 4:
                token = _a.sent();
